        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuestIdentifier = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventWishlists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventWishlists_EventParticipants_EventParticipantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    EventWishlistId = table.Column<int>(type: "integer", nullable: false),
                    Name = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    StoreLink = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventGifts_EventWishlists_EventWishlistId",
                        column: x => x.EventWishlistId,
                        principalTable: "EventWishlists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventGifts_EventWishlistId",
                table: "EventGifts",
                column: "EventWishlistId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventWishlists_EventParticipantId",
                table: "EventWishlists",
